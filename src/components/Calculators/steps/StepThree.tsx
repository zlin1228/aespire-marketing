...
export type StepThreeProps = {
  ...
  body?: string;
  disclaimer?: string;
  handleDetailedDataValue: (value: number) => void;
  moveNextStep: (value: number) => void;
  movePrevStep: (value: number) => void;
  detailedDataRate?: number;
};
